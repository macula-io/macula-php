 ...
 * reports rather than assuming an answer (macula-go-sdk's and
...
$session->publish($topic, $realm, seq: 1, payload: Value::text('hello from macula-php-sdk'), publishedAtMs: (int) (microtime(true) * 1000));
